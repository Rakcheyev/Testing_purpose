...
- [ ] Розвинути локальний Streamlit/Gradio UI для роботи з pipeline
  - [ ] Зібрати дані з `pbip_artifacts/reviews/*` у єдину аналітичну панель
  - [ ] Додати авторизацію та фільтри (домен, статус перевірки, дата)
  - [ ] Дозволити завантаження PBIP безпосередньо з UI та запуск pipeline в асинхронному режимі
